...
solo en español (FR-015); sección "cómo llegar" sin mapa interactivo embebido de
terceros (ver Assumptions del spec); rotación de fondo del hero cada 5s con
crossfade, corriendo en paralelo al parallax sin interrumpirlo (FR-017/FR-018)
...
| Estándares Técnicos de Performance               | PASS                               | `astro:assets` cubre optimización de imágenes; animaciones en GPU (`transform`/`opacity`); Astro emite cero JS por defecto salvo los scripts de parallax                                                                                                                                                                                                                     |
...
│   ├── ComoLlegar.astro        # FR-004: referencia estática de ubicación/acceso
